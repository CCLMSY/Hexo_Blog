...
![VSCode](http://source.cclmsy.cc/Images/Posts/BOT/BOT_12.png)
...
![InstallNonebot1](http://source.cclmsy.cc/Images/Posts/BOT/BOT_13.png)
## 2.2.安装pipx
...
![InstallNonebot2](http://source.cclmsy.cc/Images/Posts/BOT/BOT_14.png)
...
pipx install nb-cli
```
![InstallNonebot3](http://source.cclmsy.cc/Images/Posts/BOT/BOT_15.png)
...
![Create1](http://source.cclmsy.cc/Images/Posts/BOT/BOT_16.png)
...
[?] 创建虚拟环境? y
```
![Create2](http://source.cclmsy.cc/Images/Posts/BOT/BOT_17.png)
脚手架会自动创建并引入所需的依赖包。
...
出现以下提示则项目创建成功
![Create3](http://source.cclmsy.cc/Images/Posts/BOT/BOT_18.png)
...
![Create4](http://source.cclmsy.cc/Images/Posts/BOT/BOT_22.png)
...
![Plugin1](http://source.cclmsy.cc/Images/Posts/BOT/BOT_21.png)
按照提示输入插件名称即可。
### 5.1.3.方法三：使用pip安装
...
```
出现以下提示则安装和运行成功：
![gocq1](http://source.cclmsy.cc/Images/Posts/BOT/BOT_23.png)
按住Ctrl单击链接进入`go-cqhttp`的WebUI界面
![gocq2](http://source.cclmsy.cc/Images/Posts/BOT/BOT_24.png)

# 6.登录QQ机器人与检查
## 6.1.登录QQ机器人
点击左上角“添加账号”，输入要部署的QQ账号，密码留空，设备类型选择“Android Watch”：
（注：也可以选择账号密码登录，但可能出现账号被风控无法登录的情况，手表协议登录相对比较稳定。）
![QQLogin1](http://source.cclmsy.cc/Images/Posts/BOT/BOT_25.png)
添加完成后点击启动，待加载出二维码后点击“显示登录二维码”。
用你的手机登录要部署的QQ账号，扫描二维码登录。
![QQLogin2](http://source.cclmsy.cc/Images/Posts/BOT/BOT_26.png)
登陆完成后会有消息提示如下：
![QQLogin3](http://source.cclmsy.cc/Images/Posts/BOT/BOT_27.png)
...
<img src="http://source.cclmsy.cc/Images/Posts/BOT/BOT_28.png" alt="image" style="zoom:67%;" />
{% endhideBlock %}
