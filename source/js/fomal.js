...
function tonav() {
  ...
  document.getElementById("page-name").innerText = document.title.split(" | CCLMSY💫")[0];
}
...
$.ajax({
  ...
  data: {
    key: 'JKFBZ-DJA64-BLIUK-KVI6E-OLZO5-WXBWH',  // 这里要写你的KEY!!!
    output: 'jsonp',
  },
  dataType: 'jsonp',
...
function showWelcome() {
  ...
  let dist = getDistance(120.21551, 30.25308, ipLoacation.result.location.lng, ipLoacation.result.location.lat); //这里换成自己的经纬度
...
function createtime1() {
  var grt = new Date("26/09/2023 20:00:00"); //此处修改你的建站时间或者网站上线时间
...
function createtime2() {
  ...
  setTimeout(
    console.warn.bind(
      console,
      "%c ⚡ Powered by CCLMSY💫 %c 你正在访问CCLMSY💫の小站",
...
function share_() {
  ...
  try {
    ...
    var subTitle = title.endsWith("| CCLMSY💫") ? title.substring(0, title.length - 14) : title;
    navigator.clipboard.writeText('CCLMSY💫的站内分享\n标题：' + subTitle + '\n链接：' + url + '\n欢迎来访！🍭🍭🍭');
    new Vue({
      data: function () {
        this.$notify({
          title: "成功复制分享信息🎉",
...
function createtime() {
  ...
  // 网站诞生时间
  var grt = new Date("09/26/2023 20:00:00");
  ...
  (currentTimeHtml =/*
    hnum < 21 && hnum >= 9
      ? `<img class='boardsign' src='' title='现在是 上班时间//快去加训！'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`
      : `<img class='boardsign' src='' title='现在是 下班时间//该睡觉了zzz'>*/`<br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`),
...
if (localStorage.getItem("font") == undefined) {
  localStorage.setItem("font", "miaozisheying"); //默认字体
}
...
if (localStorage.getItem("snow") == undefined) {
  localStorage.setItem("snow", "none"); //默认开：block；默认关：none
}
...
<a class="swf" id="swf_Fangyuanali" href="javascript:;" rel="noopener external nofollow" style="font-family:'Fangyuan_ali'!important;color:black" onclick="setFont('Fangyuan_ali')">阿里方圆体</a>
<a class="swf" id="swf_miaozisheying" href="javascript:;" rel="noopener external nofollow" style="font-family:'miaozisheying'!important;color:black" onclick="setFont('miaozisheying')">喵字摄影体</a>
...
<div class="bgbox">
<a href="javascript:;" rel="noopener external nofollow" style="background-image:url(http://cclmsy.gitee.io/sourse/Backgrounds/ECY/ECY1.jpg)" class="imgbox" onclick="changeBg('url(http://cclmsy.gitee.io/sourse/Backgrounds/ECY/ECY1.jpg)')"></a>
<a href="javascript:;" rel="noopener external nofollow" style="background-image:url(http://cclmsy.gitee.io/sourse/Backgrounds/ECY/ECY2.jpg)" class="imgbox" onclick="changeBg('url(http://cclmsy.gitee.io/sourse/Backgrounds/ECY/ECY2.jpg)')"></a>
<a href="javascript:;" rel="noopener external nofollow" style="background-image:url(http://cclmsy.gitee.io/sourse/Backgrounds/ECY/ECY3.jpg)" class="imgbox" onclick="changeBg('url(http://cclmsy.gitee.io/sourse/Backgrounds/ECY/ECY3.jpg)')"></a>
<a href="javascript:;" rel="noopener external nofollow" style="background-image:url(http://cclmsy.gitee.io/sourse/Backgrounds/ECY/ECY4.jpg)" class="imgbox" onclick="changeBg('url(http://cclmsy.gitee.io/sourse/Backgrounds/ECY/ECY4.jpg)')"></a>
<a href="javascript:;" rel="noopener external nofollow" style="background-image:url(http://cclmsy.gitee.io/sourse/Backgrounds/ECY/ECY5.jpg)" class="imgbox" onclick="changeBg('url(http://cclmsy.gitee.io/sourse/Backgrounds/ECY/ECY5.jpg)')"></a>
<a href="javascript:;" rel="noopener external nofollow" style="background-image:url(http://cclmsy.gitee.io/sourse/Backgrounds/ECY/ECY6.jpg)" class="imgbox" onclick="changeBg('url(http://cclmsy.gitee.io/sourse/Backgrounds/ECY/ECY6.jpg)')"></a>
<a href="javascript:;" rel="noopener external nofollow" style="background-image:url(http://cclmsy.gitee.io/sourse/Backgrounds/ECY/ECY7.webp)" class="imgbox" onclick="changeBg('url(http://cclmsy.gitee.io/sourse/Backgrounds/ECY/ECY7.webp)')"></a>
<a href="javascript:;" rel="noopener external nofollow" style="background-image:url(http://cclmsy.gitee.io/sourse/Backgrounds/ECY/ECY8.jpg)" class="imgbox" onclick="changeBg('url(http://cclmsy.gitee.io/sourse/Backgrounds/ECY/ECY8.jpg)')"></a>
<a href="javascript:;" rel="noopener external nofollow" style="background-image:url(http://cclmsy.gitee.io/sourse/Backgrounds/ECY/ECY9.jpg)" class="imgbox" onclick="changeBg('url(http://cclmsy.gitee.io/sourse/Backgrounds/ECY/ECY9.jpg)')"></a>
<a href="javascript:;" rel="noopener external nofollow" style="background-image:url(http://cclmsy.gitee.io/sourse/Backgrounds/ECY/ECY10.webp)" class="imgbox" onclick="changeBg('url(http://cclmsy.gitee.io/sourse/Backgrounds/ECY/ECY10.webp)')"></a>
</div>
{% endfolding %}
...
{% folding cyan, 查看风景背景 %}
<div class="bgbox">
<a href="javascript:;" rel="noopener external nofollow" style="background-image:url(http://cclmsy.gitee.io/sourse/Backgrounds/Scenery/Scenery1.jpg)" class="imgbox" onclick="changeBg('url(http://cclmsy.gitee.io/sourse/Backgrounds/Scenery/Scenery1.jpg)')"></a>
<a href="javascript:;" rel="noopener external nofollow" style="background-image:url(http://cclmsy.gitee.io/sourse/Backgrounds/Scenery/Scenery2.jpg)" class="imgbox" onclick="changeBg('url(http://cclmsy.gitee.io/sourse/Backgrounds/Scenery/Scenery2.jpg)')"></a>
<a href="javascript:;" rel="noopener external nofollow" style="background-image:url(http://cclmsy.gitee.io/sourse/Backgrounds/Scenery/Scenery3.jpg)" class="imgbox" onclick="changeBg('url(http://cclmsy.gitee.io/sourse/Backgrounds/Scenery/Scenery3.jpg)')"></a>
<a href="javascript:;" rel="noopener external nofollow" style="background-image:url(http://cclmsy.gitee.io/sourse/Backgrounds/Scenery/Scenery4.jpg)" class="imgbox" onclick="changeBg('url(http://cclmsy.gitee.io/sourse/Backgrounds/Scenery/Scenery4.jpg)')"></a>
<a href="javascript:;" rel="noopener external nofollow" style="background-image:url(http://cclmsy.gitee.io/sourse/Backgrounds/Scenery/Scenery5.jpg)" class="imgbox" onclick="changeBg('url(http://cclmsy.gitee.io/sourse/Backgrounds/Scenery/Scenery5.jpg)')"></a>
<a href="javascript:;" rel="noopener external nofollow" style="background-image:url(http://cclmsy.gitee.io/sourse/Backgrounds/Scenery/Scenery6.jpg)" class="imgbox" onclick="changeBg('url(http://cclmsy.gitee.io/sourse/Backgrounds/Scenery/Scenery6.jpg)')"></a>
<a href="javascript:;" rel="noopener external nofollow" style="background-image:url(http://cclmsy.gitee.io/sourse/Backgrounds/Scenery/Scenery7.jpg)" class="imgbox" onclick="changeBg('url(http://cclmsy.gitee.io/sourse/Backgrounds/Scenery/Scenery7.jpg)')"></a>
<a href="javascript:;" rel="noopener external nofollow" style="background-image:url(http://cclmsy.gitee.io/sourse/Backgrounds/Scenery/Scenery8.jpg)" class="imgbox" onclick="changeBg('url(http://cclmsy.gitee.io/sourse/Backgrounds/Scenery/Scenery8.jpg)')"></a>
<a href="javascript:;" rel="noopener external nofollow" style="background-image:url(http://cclmsy.gitee.io/sourse/Backgrounds/Scenery/Scenery9.jpg)" class="imgbox" onclick="changeBg('url(http://cclmsy.gitee.io/sourse/Backgrounds/Scenery/Scenery9.jpg)')"></a>
<a href="javascript:;" rel="noopener external nofollow" style="background-image:url(http://cclmsy.gitee.io/sourse/Backgrounds/Scenery/Scenery10.jpg)" class="imgbox" onclick="changeBg('url(http://cclmsy.gitee.io/sourse/Backgrounds/Scenery/Scenery10.jpg)')"></a>
...
{% folding cyan, 查看萌宠背景 %}
<div class="bgbox">
<a href="javascript:;" rel="noopener external nofollow" style="background-image:url(http://cclmsy.gitee.io/sourse/Backgrounds/Pets/Pet1.jpg)" class="imgbox" onclick="changeBg('url(http://cclmsy.gitee.io/sourse/Backgrounds/Pets/Pet1.jpg)')"></a>
<a href="javascript:;" rel="noopener external nofollow" style="background-image:url(http://cclmsy.gitee.io/sourse/Backgrounds/Pets/Pet2.jpg)" class="imgbox" onclick="changeBg('url(http://cclmsy.gitee.io/sourse/Backgrounds/Pets/Pet2.jpg)')"></a>
<a href="javascript:;" rel="noopener external nofollow" style="background-image:url(http://cclmsy.gitee.io/sourse/Backgrounds/Pets/Pet3.jpg)" class="imgbox" onclick="changeBg('url(http://cclmsy.gitee.io/sourse/Backgrounds/Pets/Pet3.jpg)')"></a>
<a href="javascript:;" rel="noopener external nofollow" style="background-image:url(http://cclmsy.gitee.io/sourse/Backgrounds/Pets/Pet4.webp)" class="imgbox" onclick="changeBg('url(http://cclmsy.gitee.io/sourse/Backgrounds/Pets/Pet4.webp)')"></a>
<a href="javascript:;" rel="noopener external nofollow" style="background-image:url(http://cclmsy.gitee.io/sourse/Backgrounds/Pets/Pet5.jpg)" class="imgbox" onclick="changeBg('url(http://cclmsy.gitee.io/sourse/Backgrounds/Pets/Pet5.jpg)')"></a>
<a href="javascript:;" rel="noopener external nofollow" style="background-image:url(http://cclmsy.gitee.io/sourse/Backgrounds/Pets/Pet6.jpg)" class="imgbox" onclick="changeBg('url(http://cclmsy.gitee.io/sourse/Backgrounds/Pets/Pet6.jpg)')"></a>
<a href="javascript:;" rel="noopener external nofollow" style="background-image:url(http://cclmsy.gitee.io/sourse/Backgrounds/Pets/Pet7.jpg)" class="imgbox" onclick="changeBg('url(http://cclmsy.gitee.io/sourse/Backgrounds/Pets/Pet7.jpg)')"></a>
<a href="javascript:;" rel="noopener external nofollow" style="background-image:url(http://cclmsy.gitee.io/sourse/Backgrounds/Pets/Pet8.jpg)" class="imgbox" onclick="changeBg('url(http://cclmsy.gitee.io/sourse/Backgrounds/Pets/Pet8.jpg)')"></a>
<a href="javascript:;" rel="noopener external nofollow" style="background-image:url(http://cclmsy.gitee.io/sourse/Backgrounds/Pets/Pet9.jpg)" class="imgbox" onclick="changeBg('url(http://cclmsy.gitee.io/sourse/Backgrounds/Pets/Pet9.jpg)')"></a>
<a href="javascript:;" rel="noopener external nofollow" style="background-image:url(http://cclmsy.gitee.io/sourse/Backgrounds/Pets/Pet10.jpg)" class="imgbox" onclick="changeBg('url(http://cclmsy.gitee.io/sourse/Backgrounds/Pets/Pet10.jpg)')"></a>
...
<div class="bgbox">
<a href="javascript:;" rel="noopener external nofollow" style="background-image:url(http://cclmsy.gitee.io/sourse/Backgrounds/Mobile/mb1.webp)" class="pimgbox" onclick="changeBg('url(http://cclmsy.gitee.io/sourse/Backgrounds/Mobile/mb1.webp)')"></a>
<a href="javascript:;" rel="noopener external nofollow" style="background-image:url(http://cclmsy.gitee.io/sourse/Backgrounds/Mobile/mb2.webp)" class="pimgbox" onclick="changeBg('url(http://cclmsy.gitee.io/sourse/Backgrounds/Mobile/mb2.webp)')"></a>
<a href="javascript:;" rel="noopener external nofollow" style="background-image:url(http://cclmsy.gitee.io/sourse/Backgrounds/Mobile/mb3.webp)" class="pimgbox" onclick="changeBg('url(http://cclmsy.gitee.io/sourse/Backgrounds/Mobile/mb3.webp)')"></a>
<a href="javascript:;" rel="noopener external nofollow" style="background-image:url(http://cclmsy.gitee.io/sourse/Backgrounds/Mobile/mb4.webp)" class="pimgbox" onclick="changeBg('url(http://cclmsy.gitee.io/sourse/Backgrounds/Mobile/mb4.webp)')"></a>
<a href="javascript:;" rel="noopener external nofollow" style="background-image:url(http://cclmsy.gitee.io/sourse/Backgrounds/Mobile/mb5.webp)" class="pimgbox" onclick="changeBg('url(http://cclmsy.gitee.io/sourse/Backgrounds/Mobile/mb5.webp)')"></a>
<a href="javascript:;" rel="noopener external nofollow" style="background-image:url(http://cclmsy.gitee.io/sourse/Backgrounds/Mobile/mb6.webp)" class="pimgbox" onclick="changeBg('url(http://cclmsy.gitee.io/sourse/Backgrounds/Mobile/mb6.webp)')"></a>
<a href="javascript:;" rel="noopener external nofollow" style="background-image:url(http://cclmsy.gitee.io/sourse/Backgrounds/Mobile/mb7.webp)" class="pimgbox" onclick="changeBg('url(http://cclmsy.gitee.io/sourse/Backgrounds/Mobile/mb7.webp)')"></a>
<a href="javascript:;" rel="noopener external nofollow" style="background-image:url(http://cclmsy.gitee.io/sourse/Backgrounds/Mobile/mb8.webp)" class="pimgbox" onclick="changeBg('url(http://cclmsy.gitee.io/sourse/Backgrounds/Mobile/mb8.webp)')"></a>
<a href="javascript:;" rel="noopener external nofollow" style="background-image:url(http://cclmsy.gitee.io/sourse/Backgrounds/Mobile/mb9.webp)" class="pimgbox" onclick="changeBg('url(http://cclmsy.gitee.io/sourse/Backgrounds/Mobile/mb9.webp)')"></a>
<a href="javascript:;" rel="noopener external nofollow" style="background-image:url(http://cclmsy.gitee.io/sourse/Backgrounds/Mobile/mb10.webp)" class="pimgbox" onclick="changeBg('url(http://cclmsy.gitee.io/sourse/Backgrounds/Mobile/mb10.webp)')"></a>
<a href="javascript:;" rel="noopener external nofollow" style="background-image:url(http://cclmsy.gitee.io/sourse/Backgrounds/Mobile/mb11.webp)" class="pimgbox" onclick="changeBg('url(http://cclmsy.gitee.io/sourse/Backgrounds/Mobile/mb11.webp)')"></a>
<a href="javascript:;" rel="noopener external nofollow" style="background-image:url(http://cclmsy.gitee.io/sourse/Backgrounds/Mobile/mb12.webp)" class="pimgbox" onclick="changeBg('url(http://cclmsy.gitee.io/sourse/Backgrounds/Mobile/mb12.webp)')"></a>
<a href="javascript:;" rel="noopener external nofollow" style="background-image:url(http://cclmsy.gitee.io/sourse/Backgrounds/Mobile/mb13.webp)" class="pimgbox" onclick="changeBg('url(http://cclmsy.gitee.io/sourse/Backgrounds/Mobile/mb13.webp)')"></a>
<a href="javascript:;" rel="noopener external nofollow" style="background-image:url(http://cclmsy.gitee.io/sourse/Backgrounds/Mobile/mb14.webp)" class="pimgbox" onclick="changeBg('url(http://cclmsy.gitee.io/sourse/Backgrounds/Mobile/mb14.webp)')"></a>
<a href="javascript:;" rel="noopener external nofollow" style="background-image:url(http://cclmsy.gitee.io/sourse/Backgrounds/Mobile/mb15.webp)" class="pimgbox" onclick="changeBg('url(http://cclmsy.gitee.io/sourse/Backgrounds/Mobile/mb15.webp)')"></a>
<a href="javascript:;" rel="noopener external nofollow" style="background-image:url(http://cclmsy.gitee.io/sourse/Backgrounds/Mobile/mb16.webp)" class="pimgbox" onclick="changeBg('url(http://cclmsy.gitee.io/sourse/Backgrounds/Mobile/mb16.webp)')"></a>
...
<a href="javascript:;" rel="noopener external nofollow" class="box" style="background: linear-gradient(to top, #235385, #6621ab)" onclick="changeBg('linear-gradient(to top, #235385, #6621ab)')"></a>
<a href="javascript:;" rel="noopener external nofollow" class="box" style="background: linear-gradient(to top, #13579b, #ac6824)" onclick="changeBg('linear-gradient(to top, #13579b, #ac6824)')"></a>
</div>
{% endfolding %}
...
<a href="javascript:;" rel="noopener external nofollow" class="box" style="background: #1eb3fd" onclick="changeBg('#1eb3fd')"></a>  
<a href="javascript:;" rel="noopener external nofollow" class="box" style="background: #122073" onclick="changeBg('#122073')"></a> 
<a href="javascript:;" rel="noopener external nofollow" class="box" style="background: #ece765" onclick="changeBg('#ece765')"></a> 
